...
Site do desafio: 
https://jocile.com/Programador/Desafios/Desafio-total-de-compras
Criado a partir do desafio_compras em:
https://github.com/IllgnerPeixoto/Aula_py/
...
def adicionar_produto(total_compras):
    ...
    if adicione in produtos:
        ...
        # soma o valor dos produtos adicionados
        total_compras += produtos[adicione]
        print(
            f"{adicione} adicionado ao carrinho. Total até o momento: R$ {
                total_compras}"
        )
    else:
